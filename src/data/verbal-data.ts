...
<li>Si quedan dos opciones, relee con cada una y elige la que suene mas natural y precisa</li>
        ...
        exercises: [
          ...
          { id: "cc-13", question: "El discurso del líder fue tan ______ que logró unificar a facciones enfrentadas.", options: ["persuasivo", "monótono", "confuso", "breve"], correctAnswer: 0, explanation: "Si logró unificar facciones, el discurso tuvo poder de convencimiento = persuasivo." },
          { id: "cc-14", question: "La ______ del desierto contrasta con la ______ de la selva tropical.", options: ["aridez / exuberancia", "belleza / fealdad", "extensión / pequeñez", "calma / violencia"], correctAnswer: 0, explanation: "El desierto es árido y la selva es exuberante. Son antónimos contextuales." },
          { id: "cc-15", question: "Su ______ ante la injusticia era conocida: jamás permanecía ______ cuando veía un abuso.", options: ["rebeldía / indiferente", "cobardía / valiente", "apatía / activo", "calma / tranquilo"], correctAnswer: 0, explanation: "Si nunca era indiferente ante abusos, su actitud es rebeldía." },
          { id: "cc-16", question: "La nueva ley resultó ______: en vez de reducir la criminalidad, la ______.", options: ["contraproducente / aumentó", "efectiva / eliminó", "controversial / disminuyó", "novedosa / mantuvo"], correctAnswer: 0, explanation: "'En vez de reducir' indica que pasó lo opuesto. Contraproducente = efecto contrario." },
          { id: "cc-17", question: "El autor utilizó un tono ______ para narrar, evitando cualquier ______ personal.", options: ["objetivo / opinión", "apasionado / emoción", "literario / metáfora", "coloquial / formalidad"], correctAnswer: 0, explanation: "Evitar opiniones personales = tono objetivo." },
          { id: "cc-18", question: "La ______ del problema requería una solución igualmente ______.", options: ["complejidad / elaborada", "simplicidad / difícil", "urgencia / lenta", "gravedad / superficial"], correctAnswer: 0, explanation: "Un problema complejo requiere una solución elaborada." },
          { id: "cc-19", question: "Pese a las ______ condiciones, los exploradores mostraron gran ______.", options: ["adversas / tenacidad", "favorables / cobardía", "cambiantes / pereza", "templadas / miedo"], correctAnswer: 0, explanation: "'Pese a' indica dificultad: condiciones adversas pero continuaron = tenacidad." },
          { id: "cc-20", question: "Su respuesta fue tan ______ que nadie logró ______ su verdadera intención.", options: ["ambigua / descifrar", "clara / entender", "directa / ignorar", "sincera / dudar"], correctAnswer: 0, explanation: "Si nadie pudo descifrar su intención, la respuesta fue ambigua." }
        ]
      },
      {
...
<li><em>Meticulosidad:</em> cuidado extremo en los detalles</li>
        ...
        exercises: [
          ...
          { id: "cl-13", question: "El proyecto era viable; ______, fue rechazado por falta de presupuesto.", options: ["no obstante", "por lo tanto", "además", "incluso"], correctAnswer: 0, explanation: "Viable PERO rechazado = contraste. 'No obstante' es adversativo." },
          { id: "cl-14", question: "Estudió con dedicación ______ aprobó con la nota más alta.", options: ["y por ello", "pero", "aunque", "sin embargo"], correctAnswer: 0, explanation: "Estudiar causa aprobar. 'Y por ello' expresa consecuencia." },
          { id: "cl-15", question: "No solo obtuvo el primer lugar, ______ rompió el récord.", options: ["sino que también", "pero", "aunque", "sin embargo"], correctAnswer: 0, explanation: "'No solo... sino que también' añade un logro superior." },
          { id: "cl-16", question: "La empresa cerró ______ la mala administración ______ la caída de ventas.", options: ["debido a / y", "a pesar de / y", "gracias a / pero", "debido a / aunque"], correctAnswer: 0, explanation: "Dos causas sumadas. 'Debido a' + 'y' las conecta causalmente." },
          { id: "cl-17", question: "______ llovía intensamente, el evento se realizó al aire libre.", options: ["Aunque", "Porque", "Como", "Ya que"], correctAnswer: 0, explanation: "'Aunque' introduce una concesión: llovía pero se hizo igual." },
          { id: "cl-18", question: "La obra fue un éxito; ______, la crítica le dio reseñas negativas.", options: ["sin embargo", "por consiguiente", "es decir", "igualmente"], correctAnswer: 0, explanation: "Éxito vs. reseñas negativas = contraste. 'Sin embargo' marca oposición." },
          { id: "cl-19", question: "Necesitamos reducir costos; ______, debemos eliminar gastos innecesarios.", options: ["por lo tanto", "sin embargo", "aunque", "pese a ello"], correctAnswer: 0, explanation: "Reducir costos → eliminar gastos. Consecuencia lógica." },
          { id: "cl-20", question: "Se lesionó; ______, decidió competir ______ no quería decepcionar al equipo.", options: ["aun así / porque", "por eso / aunque", "entonces / pero", "además / ya que"], correctAnswer: 0, explanation: "'Aun así' = pese a la lesión. 'Porque' explica la razón." }
        ]
      }
    ]
  },
...
<li><strong>No leer todas las opciones:</strong> A veces la primera opcion parece correcta, pero una posterior es mas completa y precisa.</li>
        ...
        exercises: [
          ...
          { id: "cg-13", question: "Un texto explica cómo el cambio climático afecta migración, alimento y hábitat de las aves. El tema central es:", options: ["El impacto del cambio climático en las aves", "La migración de las aves", "Los hábitats de las aves", "Las fuentes de alimento"], correctAnswer: 0, explanation: "Los tres aspectos son efectos del cambio climático en las aves." },
          { id: "cg-14", question: "Un artículo describe ventajas del trabajo remoto, desventajas y recomendaciones. La estructura es:", options: ["Ventajas-Desventajas-Recomendaciones", "Causa-Efecto-Solución", "Introducción-Desarrollo-Conclusión", "Tesis-Antítesis-Síntesis"], correctAnswer: 0, explanation: "Presenta pros, contras y cierra con consejos." },
          { id: "cg-15", question: "Un texto dice: 'la IA creará millones de empleos nuevos, pero eliminará muchos existentes.' El tono es:", options: ["Equilibrado y realista", "Pesimista", "Optimista ingenuo", "Indiferente"], correctAnswer: 0, explanation: "Reconoce creación y eliminación = equilibrado." },
          { id: "cg-16", question: "Si un texto usa 'está comprobado', 'los datos demuestran', 'según investigaciones', ¿qué tipo de texto es?", options: ["Expositivo-científico", "Narrativo", "Poético", "Publicitario"], correctAnswer: 0, explanation: "Apela a evidencia y datos = expositivo o científico." },
          { id: "cg-17", question: "Un ensayo argumenta que los videojuegos desarrollan habilidades, cita estudios y refuta críticas. El propósito es:", options: ["Convencer de los beneficios", "Informar estadísticas", "Narrar experiencias", "Describir tipos"], correctAnswer: 0, explanation: "Argumentar + citar + refutar = persuadir." },
          { id: "cg-18", question: "Un texto describe: descubrimiento de penicilina, desarrollo de antibióticos, resistencia actual. La organización es:", options: ["Cronológica", "General a particular", "Causa y efecto", "Comparación"], correctAnswer: 0, explanation: "Sigue secuencia temporal: pasado → desarrollo → presente." },
          { id: "cg-19", question: "Si un autor escribe: 'Debemos actuar ahora o enfrentaremos consecuencias irreversibles', su intención es:", options: ["Exhortar a la acción", "Informar", "Narrar", "Describir"], correctAnswer: 0, explanation: "'Debemos actuar ahora' es un llamado directo = exhortativo." },
          { id: "cg-20", question: "Un texto sobre el café menciona: origen, llegada a Europa, variedades y economía. ¿Mejor título?", options: ["El café: historia, variedades e importancia", "Cómo preparar café", "El café en Europa", "Etiopía: cuna del café"], correctAnswer: 0, explanation: "El título debe abarcar todos los subtemas mencionados." },
          { id: "ip-13", question: "'Las renovables son accesibles: solar bajó 90%, eólica compite con gas, geotérmica se expande.' La idea principal es:", options: ["Las renovables son económicamente viables", "La solar es la más barata", "El gas es caro", "La geotérmica es mejor"], correctAnswer: 0, explanation: "Todos los ejemplos apoyan que las renovables son viables." },
          { id: "ip-14", question: "'Adolescentes que duermen <7h: peor rendimiento, irritabilidad, problemas de concentración, riesgo de obesidad.' Idea principal:", options: ["La falta de sueño afecta múltiples aspectos", "Tienen problemas de concentración", "Dormir poco causa obesidad", "El rendimiento depende del sueño"], correctAnswer: 0, explanation: "Múltiples efectos = la idea los engloba todos." },
          { id: "ip-15", question: "'El español: 500M hablantes, oficial en 20 países, tercera lengua en internet.' Esto apoya que:", options: ["El español tiene importancia global", "Internet está en español", "Hay muchos países hispanos", "Es el más hablado"], correctAnswer: 0, explanation: "Los tres datos apuntan a la relevancia mundial." },
          { id: "ip-16", question: "'Aunque las redes conectan personas lejanas, también generan adicción, comparación social y baja autoestima.' Idea principal:", options: ["Las redes tienen efectos negativos pese a beneficios", "Son completamente negativas", "La adicción es lo peor", "Conectar no importa"], correctAnswer: 0, explanation: "El peso está en los efectos negativos (3 vs 1 beneficio)." },
          { id: "ip-17", question: "'La lectura desarrolla vocabulario, comprensión, imaginación y empatía.' Idea principal:", options: ["La lectura tiene múltiples beneficios", "Mejora el vocabulario", "Los personajes generan empatía", "La imaginación se desarrolla"], correctAnswer: 0, explanation: "Se enumeran 4 beneficios = múltiples beneficios." },
          { id: "ip-18", question: "'Los océanos absorben CO₂, regulan temperatura, producen 50%+ del oxígeno y albergan millones de especies.' Propósito:", options: ["Destacar la importancia vital de los océanos", "Explicar producción de oxígeno", "Describir especies marinas", "Informar sobre CO₂"], correctAnswer: 0, explanation: "Cada dato refuerza lo crucial que son los océanos." },
          { id: "ip-19", question: "Un párrafo menciona: nivel del mar, deshielo, temperaturas récord, sequías. Son ejemplos de:", options: ["Evidencias del cambio climático", "Problemas polares", "Fenómenos normales", "Contaminación del agua"], correctAnswer: 0, explanation: "Todas son manifestaciones del cambio climático." },
          { id: "ip-20", question: "'El ejercicio fortalece el corazón. Reduce el estrés. Mejora el sueño. Por todo esto, se recomienda.' La idea principal está en:", options: ["La última oración", "La primera", "La segunda", "La tercera"], correctAnswer: 0, explanation: "Las tres primeras son argumentos. La última es la conclusión = idea principal." }
        ]
      },
      {
        id: "inferencias",
...
<li><strong>Evalua la logica:</strong> Las conclusiones del autor se derivan realmente de los datos que presenta?</li>
        ...
        exercises: [
          ...
          { id: "inf-13", question: "'El restaurante de tres estrellas Michelin ahora tenía mesas vacías cada noche.' Se infiere que:", options: ["Perdió calidad o prestigio", "Las estrellas no importan", "La gente dejó de comer fuera", "Cambió de ubicación"], correctAnswer: 0, explanation: "De prestigioso a vacío = algo cambió para mal." },
          { id: "inf-14", question: "'María revisó su maleta, miró el reloj y caminó hacia la puerta de embarque.' Se infiere que:", options: ["Está por tomar un vuelo", "Llega de viaje", "Trabaja en el aeropuerto", "Recoge a alguien"], correctAnswer: 0, explanation: "Maleta + reloj + puerta de embarque = tomará un vuelo." },
          { id: "inf-15", question: "'A pesar de las fuertes lluvias, el estadio estaba lleno.' Se infiere que:", options: ["El evento era muy importante", "El estadio tenía techo", "La lluvia no era fuerte", "Las entradas eran gratis"], correctAnswer: 0, explanation: "Fueron pese a la lluvia = evento suficientemente importante." },
          { id: "inf-16", question: "'El doctor le dijo que dejara la sal y caminara 30 minutos diarios.' Se infiere:", options: ["Tiene problemas de presión", "Es deportista", "Tiene fractura", "Es vegetariano"], correctAnswer: 0, explanation: "Restricción de sal + ejercicio = medidas para hipertensión." },
          { id: "inf-17", question: "'Las ventas de paraguas se duplicaron en la última semana.' Se infiere:", options: ["Ha llovido mucho", "Están de moda", "Hay promoción", "Son baratos"], correctAnswer: 0, explanation: "Aumento repentino de paraguas = clima lluvioso." },
          { id: "inf-18", question: "'El candidato evitó responder y cambió de tema sobre los fondos.' Se infiere:", options: ["Oculta algo sobre los fondos", "No entendió", "No era importante", "Ya respondió"], correctAnswer: 0, explanation: "Evadir y cambiar de tema = señal de ocultar algo." },
          { id: "inf-19", question: "'Después de la clase, todos aplaudieron espontáneamente.' Se infiere:", options: ["La clase fue excepcional", "Era obligatorio", "La clase fue corta", "Estaban contentos de que terminara"], correctAnswer: 0, explanation: "Aplauso espontáneo = apreciación genuina." },
          { id: "inf-20", question: "'La empresa contrató 200 empleados y alquiló otro edificio.' Se infiere:", options: ["Está en crecimiento", "Tiene problemas", "Los antiguos renunciaron", "El edificio se dañó"], correctAnswer: 0, explanation: "Más personal + más espacio = crecimiento." }
        ]
      },
      {
        id: "proposito-tono",
...
<li><strong>Verifica el ORDEN</strong> de la relacion. Si el par original es parte:todo, la respuesta tambien debe ser parte:todo, NO todo:parte.</li>
        ...
        exercises: [
          ...
          { id: "ac-13", question: "MÉDICO : HOSPITAL como PROFESOR : ?", options: ["Escuela", "Libro", "Alumno", "Examen"], correctAnswer: 0, explanation: "Profesional → lugar donde ejerce." },
          { id: "ac-14", question: "CUCHILLO : CORTAR como MARTILLO : ?", options: ["Golpear", "Clavo", "Madera", "Construir"], correctAnswer: 0, explanation: "Herramienta → acción que realiza." },
          { id: "ac-15", question: "HAMBRE : COMER como CANSANCIO : ?", options: ["Dormir", "Trabajar", "Cama", "Noche"], correctAnswer: 0, explanation: "Necesidad → acción que la satisface." },
          { id: "ac-16", question: "AGUA : HIELO como LAVA : ?", options: ["Roca", "Volcán", "Fuego", "Calor"], correctAnswer: 0, explanation: "Sustancia líquida → su forma sólida." },
          { id: "ac-17", question: "ORUGA : MARIPOSA como RENACUAJO : ?", options: ["Rana", "Agua", "Insecto", "Huevo"], correctAnswer: 0, explanation: "Fase juvenil → fase adulta (metamorfosis)." },
          { id: "ac-18", question: "CAPÍTULO : LIBRO como ESCENA : ?", options: ["Película", "Actor", "Teatro", "Guion"], correctAnswer: 0, explanation: "Parte → todo al que pertenece." },
          { id: "ac-19", question: "DÍA : SEMANA como MES : ?", options: ["Año", "Día", "Siglo", "Semana"], correctAnswer: 0, explanation: "Unidad menor → unidad mayor que la contiene." },
          { id: "ac-20", question: "TELESCOPIO : ESTRELLAS como MICROSCOPIO : ?", options: ["Células", "Lentes", "Laboratorio", "Aumento"], correctAnswer: 0, explanation: "Instrumento → lo que permite observar." }
        ]
      },
      {
...
Con esta lista mental de preguntas, podras clasificar rapidamente cualquier relacion analogica.`,
        ...
        exercises: [
          ...
          { id: "acx-13", question: "CENSURA : LIBERTAD como DIQUE : ?", options: ["Inundación", "Río", "Agua", "Presa"], correctAnswer: 0, explanation: "Lo que impide → lo que sería liberado sin contención." },
          { id: "acx-14", question: "VACUNA : ENFERMEDAD como EDUCACIÓN : ?", options: ["Ignorancia", "Escuela", "Profesor", "Libro"], correctAnswer: 0, explanation: "Previene → aquello que previene." },
          { id: "acx-15", question: "MAPA : TERRITORIO como PLANO : ?", options: ["Edificio", "Arquitecto", "Papel", "Dibujo"], correctAnswer: 0, explanation: "Representación → lo que representa." },
          { id: "acx-16", question: "AMNESIA : MEMORIA como CEGUERA : ?", options: ["Vista", "Ojos", "Oscuridad", "Bastón"], correctAnswer: 0, explanation: "Pérdida → facultad que se pierde." },
          { id: "acx-17", question: "BRÚJULA : NAVEGANTE como CONSTITUCIÓN : ?", options: ["Gobernante", "País", "Ley", "Justicia"], correctAnswer: 0, explanation: "Lo que guía → a quién guía." },
          { id: "acx-18", question: "INFLACIÓN : ECONOMÍA como FIEBRE : ?", options: ["Cuerpo", "Medicina", "Hospital", "Virus"], correctAnswer: 0, explanation: "Síntoma de mal funcionamiento → sistema afectado." },
          { id: "acx-19", question: "RAÍZ : ÁRBOL como CIMIENTO : ?", options: ["Edificio", "Cemento", "Suelo", "Arquitecto"], correctAnswer: 0, explanation: "Base/soporte invisible → estructura que sostiene." },
          { id: "acx-20", question: "HUELLA : PASO como CENIZA : ?", options: ["Fuego", "Madera", "Gris", "Volcán"], correctAnswer: 0, explanation: "Evidencia/rastro → lo que la produjo." }
        ]
      }
    ]
  },
...
<li>Frases ambiguas donde no queda claro cual es el sujeto ni cual es el complemento.</li>
        ...
        exercises: [
          ...
          { id: "con-13", question: "¿Concordancia correcta?", options: ["Había muchas personas", "Habían muchas personas", "Hubieron muchas personas", "Han habido muchas"], correctAnswer: 0, explanation: "'Haber' impersonal siempre en singular: 'Había'." },
          { id: "con-14", question: "Forma correcta:", options: ["La gente salió corriendo", "La gente salieron", "Las gentes salieron", "La gente salimos"], correctAnswer: 0, explanation: "'La gente' es colectivo singular: 'salió'." },
          { id: "con-15", question: "¿Correcta?", options: ["El agua está fría", "La agua está fría", "El agua está frío", "La agua está frío"], correctAnswer: 0, explanation: "'Agua' usa 'el' por a tónica pero es femenino: 'fría'." },
          { id: "con-16", question: "Error en: 'Se necesitan secretaria bilingüe con experiencia.'", options: ["Debe ser 'Se necesita' (singular)", "Debe ser 'secretarias'", "Debe ser 'con experiencias'", "No tiene error"], correctAnswer: 0, explanation: "Con sustantivo singular: 'Se necesita secretaria'." },
          { id: "con-17", question: "¿Correcta?", options: ["Uno de los estudiantes aprobó con honores", "Uno de los estudiantes aprobaron", "Unos de los estudiantes aprobó", "Uno de los estudiante aprobó"], correctAnswer: 0, explanation: "Sujeto 'uno' (singular): verbo singular 'aprobó'." },
          { id: "con-18", question: "Concordancia correcta:", options: ["Su Majestad está complacido", "Su Majestad están complacidos", "Su Majestad está complacida", "Sus Majestades está complacido"], correctAnswer: 0, explanation: "Si se refiere a un rey, el adjetivo va en masculino." },
          { id: "con-19", question: "¿Correcta con sujeto compuesto?", options: ["Juan y María llegaron temprano", "Juan y María llegó", "Juan y María llega", "Juan y María llegarás"], correctAnswer: 0, explanation: "Sujeto compuesto = plural: 'llegaron'." },
          { id: "con-20", question: "Identifique la correcta:", options: ["Me gustan las películas de acción", "Me gusta las películas", "Me gustan la películas", "Me gusta las película"], correctAnswer: 0, explanation: "Sujeto 'las películas' (plural): 'gustan'." }
        ]
      },
      {
...
<li>"sino" (conjuncion adversativa: "no es rojo sino azul") vs. "si no" (condicional + negacion: "si no vienes, ire solo")</li>
        ...
        exercises: [
          ...
          { id: "oa-12", question: "¿Cuál palabra es aguda con tilde?", options: ["Canción", "Examen", "Lápiz", "Árbol"], correctAnswer: 0, explanation: "Canción: aguda terminada en -n → lleva tilde." },
          { id: "oa-13", question: "¿Cuál oración tiene error de acentuación?", options: ["Dame el té que esta en la mesa", "Él quiere ir al cine", "¿Cuándo llegas?", "Sé que vendrás"], correctAnswer: 0, explanation: "'Esta' debe ser 'está' (verbo estar, con tilde)." },
          { id: "oa-14", question: "¿Cuál palabra lleva tilde diacrítica correctamente?", options: ["Sí (afirmación)", "Dé (preposición)", "Tú (posesivo)", "Mí (adjetivo)"], correctAnswer: 0, explanation: "'Sí' con tilde = afirmación." },
          { id: "oa-15", question: "'Búho' lleva tilde porque:", options: ["Tiene hiato (vocal débil tónica)", "Es esdrújula", "Es aguda en vocal", "Es grave en consonante"], correctAnswer: 0, explanation: "Hiato: ú-o. Vocal débil tónica junto a fuerte siempre lleva tilde." },
          { id: "oa-16", question: "¿Cuál serie está correctamente escrita?", options: ["había, reír, oír, país", "habia, reir, oir, pais", "había, reir, oír, pais", "habia, reír, oir, país"], correctAnswer: 0, explanation: "Todas tienen hiato con vocal débil tónica: todas llevan tilde en la i." },
          { id: "oa-17", question: "¿Cuál palabra NO lleva tilde?", options: ["Fue", "Quién", "Cuánto", "Dónde"], correctAnswer: 0, explanation: "'Fue' es monosílabo sin valor diacrítico." },
          { id: "oa-18", question: "Identifica la palabra sobreesdrújula:", options: ["Dígamelo", "Rápido", "Médico", "Teléfono"], correctAnswer: 0, explanation: "Dí-ga-me-lo: sobreesdrújula (siempre lleva tilde)." },
          { id: "oa-19", question: "¿Cuándo lleva tilde 'solo'?", options: ["La RAE recomienda no tildarla nunca", "Siempre como adverbio", "Solo cuando significa 'solamente'", "Nunca ha llevado tilde"], correctAnswer: 0, explanation: "Desde 2010, la RAE indica que 'solo' puede escribirse sin tilde siempre." },
          { id: "oa-20", question: "¿Cuál es correcta?", options: ["¿Por qué no viniste?", "¿Porqué no viniste?", "¿Por que no viniste?", "¿Porque no viniste?"], correctAnswer: 0, explanation: "'Por qué' (separado, con tilde) se usa en preguntas." },
          { id: "pun-13", question: "¿Cuál usa correctamente el punto y coma?", options: ["Llegó tarde; sin embargo, terminó", "Llegó tarde, sin embargo; terminó", "Llegó tarde sin embargo; terminó", "Llegó, tarde; sin embargo terminó"], correctAnswer: 0, explanation: "Punto y coma separa oraciones enlazadas por conector adversativo." },
          { id: "pun-14", question: "Los dos puntos se usan correctamente en:", options: ["Estimado señor: Le escribo para...", "Estimado: señor Le escribo", "Estimado señor Le escribo: para", "Estimado señor, Le: escribo"], correctAnswer: 0, explanation: "Después del saludo en cartas formales van dos puntos." },
          { id: "pun-15", question: "¿Dónde van las comas? 'Juan mi mejor amigo vive en Panamá'", options: ["Juan, mi mejor amigo, vive en Panamá", "Juan mi mejor amigo, vive", "Juan, mi mejor amigo vive", "Juan mi, mejor amigo, vive"], correctAnswer: 0, explanation: "'Mi mejor amigo' es aposición explicativa: va entre comas." },
          { id: "pun-16", question: "¿Cuál uso de comillas es correcto?", options: ["El profesor dijo: «Estudien»", "El profesor «dijo» estudien", "El profesor dijo estudien «para el» examen", "«El profesor» dijo estudien"], correctAnswer: 0, explanation: "Las comillas encierran citas textuales directas." },
          { id: "pun-17", question: "¿Qué signo falta? 'Compré frutas manzanas, peras y uvas'", options: ["Dos puntos después de 'frutas'", "Punto y coma", "Coma", "Punto"], correctAnswer: 0, explanation: "Los dos puntos preceden enumeraciones." },
          { id: "pun-18", question: "¿Cuál tiene la coma correcta?", options: ["Si llueve, no iremos al parque", "Si llueve no, iremos", "Si, llueve no iremos", "Si llueve no iremos, al parque"], correctAnswer: 0, explanation: "Subordinada condicional primero → coma después." },
          { id: "pun-19", question: "Paréntesis correcto en:", options: ["García Márquez (1927-2014) ganó el Nobel", "García (Márquez 1927)-2014", "García Márquez 1927(-2014)", "(Gabriel) García Márquez"], correctAnswer: 0, explanation: "Los paréntesis encierran información complementaria." },
          { id: "pun-20", question: "¿En cuál sobra una coma?", options: ["El presidente, dijo que habría cambios", "El presidente, cansado, se retiró", "María, Juan y Pedro vinieron", "Ayer, cuando llegué, llovía"], correctAnswer: 0, explanation: "No debe haber coma entre sujeto y verbo." }
        ]
      },
      {
...
<li>Usar "porque" cuando hay consecuencia: "Llovio porque las calles se inundaron." INCORRECTO (la causa es la lluvia, no la inundacion; deberia ser "asi que" o "por lo tanto").</li>
        ...
        exercises: [
          ...
          { id: "cr-13", question: "'No tenía hambre; ______, se comió todo el plato.'", options: ["no obstante", "por lo tanto", "es decir", "porque"], correctAnswer: 0, explanation: "Contraste: no tenía hambre PERO comió. 'No obstante' = adversativo." },
          { id: "cr-14", question: "'La reunión se canceló ______ la ausencia del director.'", options: ["debido a", "a pesar de", "además de", "en lugar de"], correctAnswer: 0, explanation: "La ausencia es la CAUSA. 'Debido a' introduce causa." },
          { id: "cr-15", question: "'Primero mezcla ingredientes secos. ______, agrega los líquidos.'", options: ["A continuación", "Sin embargo", "Por el contrario", "No obstante"], correctAnswer: 0, explanation: "Secuencia de pasos. 'A continuación' = siguiente paso." },
          { id: "cr-16", question: "'El plan era ambicioso. ______, resultó ser el más exitoso.'", options: ["Con todo", "Además", "Por ejemplo", "En efecto"], correctAnswer: 0, explanation: "'Con todo' indica que pese a lo esperado, tuvo éxito. Concesivo." },
          { id: "cr-17", question: "'La empresa invierte en tecnología. ______, capacita a su personal.'", options: ["Asimismo", "Sin embargo", "Por el contrario", "Es decir"], correctAnswer: 0, explanation: "Ambas acciones van en la misma dirección. 'Asimismo' = también." },
          { id: "cr-18", question: "'El presupuesto es limitado; ______, debemos priorizar.'", options: ["en consecuencia", "no obstante", "aunque", "por el contrario"], correctAnswer: 0, explanation: "Causa → efecto. 'En consecuencia' expresa resultado." },
          { id: "cr-19", question: "'Algunos prefieren verano; ______, otros disfrutan el invierno.'", options: ["en cambio", "por lo tanto", "además", "es decir"], correctAnswer: 0, explanation: "Preferencias opuestas. 'En cambio' introduce otra perspectiva." },
          { id: "cr-20", question: "'El experimento falló tres veces. ______, el científico no se rindió.'", options: ["A pesar de ello", "Por eso", "En efecto", "Es decir"], correctAnswer: 0, explanation: "Perseveró pese a fallos. 'A pesar de ello' = concesión." }
        ]
      },
      {
...
<li>Busca comparativos dobles (mas mejor) y verbos "haber" mal conjugados (hubieron, habemos).</li>
        ...
        exercises: [
          ...
          { id: "vl-13", question: "¿Cuál tiene solecismo?", options: ["Habemos muchos estudiantes aquí", "Hay muchos estudiantes aquí", "Somos muchos estudiantes", "Estamos muchos estudiantes"], correctAnswer: 0, explanation: "'Habemos' es solecismo. Lo correcto: 'Hay' o 'Somos'." },
          { id: "vl-14", question: "¿Cuál es redundante?", options: ["Lapso de tiempo", "Período extenso", "Intervalo corto", "Momento breve"], correctAnswer: 0, explanation: "'Lapso' ya significa espacio de tiempo. Es redundante." },
          { id: "vl-15", question: "Identifique el barbarismo:", options: ["Preveer los resultados", "Prever los resultados", "Anticipar los resultados", "Calcular los resultados"], correctAnswer: 0, explanation: "'Preveer' no existe. Lo correcto es 'prever'." },
          { id: "vl-16", question: "¿Cuál tiene vicio?", options: ["Me dijo de que vendría", "Me dijo que vendría", "Dijo que vendría", "Aseguró que vendría"], correctAnswer: 0, explanation: "'Decir de que' es dequeísmo. Correcto: 'Me dijo que'." },
          { id: "vl-17", question: "¿Cuál es pleonasmo?", options: ["Subir para arriba", "Subir rápido", "Subir al segundo piso", "Subir por escaleras"], correctAnswer: 0, explanation: "'Subir' ya implica arriba. Redundante." },
          { id: "vl-18", question: "¿Forma correcta?", options: ["Dieciséis personas asistieron", "Diez y seis personas", "Diesiseis personas", "Dieciseis personas"], correctAnswer: 0, explanation: "'Dieciséis' con tilde es la grafía correcta." },
          { id: "vl-19", question: "Identifique la anfibología:", options: ["Vi al perro de mi vecino con su collar", "El perro de mi vecino es grande", "Mi vecino pasea a su perro", "El perro ladra mucho"], correctAnswer: 0, explanation: "'Con su collar' es ambiguo: ¿del perro o del vecino?" },
          { id: "vl-20", question: "¿Correcta?", options: ["En relación con el tema...", "En relación al tema...", "Con relación del tema...", "En relación del tema..."], correctAnswer: 0, explanation: "Correcto: 'en relación CON' (no 'al' ni 'del')." }
        ]
      }
    ]
  }
